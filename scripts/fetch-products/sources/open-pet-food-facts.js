/**
 * open-pet-food-facts.js — Open Pet Food Facts API
 *
 * Bron: https://world.openpetfoodfacts.org/
 * Gratis, geen API key nodig. ~15.000 producten.
 *
 * Werkt in blokken:
...
/**
 * Haal alle producten op uit Open Pet Food Facts — in blokken per pagina.
 *
 * @param {number} maxPages - Maximaal aantal pagina's (0 = alles)
 * @returns {Promise<object[]>} Array van producten
 */
export async function fetchOpenPetFoodFacts(maxPages = 0) {
